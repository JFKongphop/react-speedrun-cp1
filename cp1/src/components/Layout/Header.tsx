...
export const Header = () => {
  ...
  return (
    <div 
      className="sticky xl:static top-0 navbar bg-primary min-h-0 flex-shrink-0 justify-between z-20 shadow-md shadow-secondary px-0 sm:px-2"
    >
      <div className="navbar-start w-auto xl:w-1/2">
        ...
        <Link to="/" className="hidden xl:flex items-center gap-1 ml-4 mr-6 shrink-0">
